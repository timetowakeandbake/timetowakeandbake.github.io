                            ...
                            <div class="position-center">
                                ...
                                <div class="form-group">
                                   ...
                                   <div class="form-group">
                                    ...
                                    <input type="file" name = "category_img" class="form-control" id="exampleInputEmail1" >
                                    <img src ="{{URL::to('public/upload/product/'.$edit_value->category_img)}}" height="100" width="100">
                                </div>
