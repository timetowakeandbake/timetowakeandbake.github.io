...
/*            $share_image = url('public/frontend/images/share_news.png');*/
    ...
    public function bai_viet(Request $request,$post_slug){
        ...
        return view('pages.baiviet.baiviet')->with('category',$cate_product)->with('brand',$brand_product)->with('meta_desc',$meta_desc)->with('meta_keywords',$meta_keywords)->with('meta_title',$meta_title)->with('url_canonical',$url_canonical)->with('slider',$slider)->with('post_by_id',$post_by_id)->with('category_post',$category_post)->with('related',$related)->with('share_image',$share_image)->with('post_cate',$post_cate);
    }
